...
$route = '/services/full/:service_id/';
$app->get($route, function ($get_service_id)  use ($app,$api_key,$base_url){

	$ReturnObject = array();

	$get_service_id = filter_var($get_service_id,FILTER_SANITIZE_STRING);
